...
module Cardano.Ledger.Voltaire.Prototype.TxBody
  ( TxBody
      ( TxBody,
        TxBodyConstr,
        TxBody',
...
deriving instance
  (NFData (Value era), Era era, VoltaireClass era) =>
  NFData (TxBodyRaw era)

deriving instance
  (TransValue Eq era, VoltaireClass era) =>
  Eq (TxBodyRaw era)
...
deriving instance
  (NoThunks (Value era), VoltaireClass era) =>
...
deriving newtype instance
  (Typeable era, NoThunks (Value era), VoltaireClass era) =>
  NoThunks (TxBody era)
