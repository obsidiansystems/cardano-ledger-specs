...
module Cardano.Ledger.Voltaire.Prototype.Rules.Utxo where
...
import Cardano.Ledger.Voltaire.Prototype.TxBody (TxBody)
...
-- | The UTxO transition rule for the Voltaire prototype eras.
utxoTransition ::
  forall era.
  ( VoltaireClass era,
    UsesTxBody era,
